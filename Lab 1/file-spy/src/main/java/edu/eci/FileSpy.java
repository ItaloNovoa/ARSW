...
public class FileSpy {
    ...
    private static final String DIR_TO_WATCH = "C:\\Users\\ItaloPC\\Downloads\\temp";
    ...
    public static void main(String[] args) throws Exception {
        ...
        /**
         * WatchService
         * Un servicio de vigilancia que vigila los objetos registrados en busca de cambios y eventos. 
         * Por ejemplo, un administrador de archivos puede usar un servicio de vigilancia para 
         * monitorear los cambios en un directorio, de modo
         */
